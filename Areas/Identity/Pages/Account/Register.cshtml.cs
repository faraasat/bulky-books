...
namespace BulkyBook.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        [BindProperty]  // This means that Input Will be available to its html page
        ...
        public class InputModel
        {
            ...
            public string PhoneNumber { get; set; }  // This property is already present in ASPUser database tables
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                Input.RoleList = _roleManager.Roles.Where(u => u.Name == StaticDetails.Role_User_Comp).Select(x => x.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
                });
